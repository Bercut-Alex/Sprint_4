...
- `test_get_book_genre_nonexistent_book_returns_none` — для несуществующей книги ничего возвращается 
...
- `test_get_list_of_favorites_books_empty_by_defoult` — список избранного по умолчанию пуст
